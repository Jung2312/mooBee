...
public class ReportForm {
	...
	private void initialize() {
		...
		JButton btnNewButton_1 = new ReportButton2("신고하기");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// 체크박스가 체크되지 않았으면 경고 메시지 표시
					...
					int confirm = JOptionPane.showConfirmDialog(frame, "정말 신고하시겠습니까?", "확인", JOptionPane.YES_NO_OPTION,
					...
					if (confirm == JOptionPane.YES_OPTION) {
						...
						if (tempMgr.insertWarning(item, cinemaNum, date, docid, seat)) {
							JOptionPane.showMessageDialog(frame, "신고가 접수되었습니다.", "신고 완료",
